...
wn = Tk()
wn.title('chaitu QR Code Generator')
wn.geometry('700x700')
wn.config(bg='pink')
headingFrame = Frame(wn,bg="violet",bd=5)
...
label1 = Label(Frame1,text="Enter the text/URL: ",bg="red",fg='yellow',font=('Courier',13,'bold'))
...
label2 = Label(Frame2,text="Enter the location to save the QR Code: ",bg="red",fg='yellow',font=('Courier',13,'bold'))
...
label3 = Label(Frame3,text="Enter the name of the QR Code: ",bg="red",fg='yellow',font=('Courier',13,'bold'))
...
label4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 being 21x21: ",bg="red",fg='yellow',font=('Courier',13,'bold'))
...
button = Button(wn, text='Generate Code',font=('Courier',15,'normal'),fg="red",bg="violet",command=generateCode)
